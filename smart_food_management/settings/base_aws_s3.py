...
STATICFILES_STORAGE = 'smart_food_management.common.aws.custom_storages.StaticStorage'
DEFAULT_FILE_STORAGE = 'smart_food_management.common.aws.custom_storages.MediaStorage'
