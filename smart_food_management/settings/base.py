"""
Django settings for smart_food_management project.
...
ALLOWED_HOSTS = [
    "smart-food-management-prod.apigateway.in",
    "smart-food-management-alpha.apigateway.in",
    "smart-food-management-beta.apigateway.in",
    "smart-food-management-gamma.apigateway.in",
    "smart-food-management-staging.apigateway.in",
    "127.0.0.1",
    "localhost",
    "heavy-suits-beam.loca.lt"
]
...
WSGI_APPLICATION = 'smart_food_management.wsgi.application'
...
LOGGING = {
    ...
    'formatters': {
        ...
        'console': {
            'format': "[%(request_id)s] [smart_food_management - "+os.environ.get("STAGE", "local")+
...
# ****************** App Source Config ******************
SMART_FOOD_MANAGEMENT_SOURCE = "smart-food-management-source"
